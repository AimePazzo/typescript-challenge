...
// This Reverse Array
const reverseArray = (arrNumbers: number[]) => {
...
const reverseArrayInplace = (numbers: number[]) => {
    let left: number = 0;
...
console.log('====================================');
// Palindrome using Built-in function

const palindrome = (str: string) => {
    const strSplit: string[] = str.split('');
    const strReverse: string[] = strSplit.reverse();
    const strJoin: string = strReverse.join('');
    return strJoin === str ? true : false
}
...
const arrSort = (arrNumbers: number[]) => {
